...
c.NotebookApp.tornado_settings = {
    'headers': {
        'Content-Security-Policy': "frame-ancestors http://localhost:5601 http://localhost:5601/*",
        "Access-Control-Allow-Origin": "http://locahost:5601"
    }
}
...
#  Choices: any of ['sha512', 'blake2s', 'sha3_256', 'sha1', 'sha3_224', 'sha3_384', 'md5', 'sha256', 'sha384', 'sha3_512', 'sha224', 'blake2b']
#  Default: 'sha256'
